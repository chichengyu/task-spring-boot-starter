...
<p align="left">
    ...
    <a href="https://github.com/chichengyu/task-spring-boot-starter">
        <img src="https://img.shields.io/badge/last version-1.3.8.RELEASE-green" alt="version-1.3.8.RELEASE" />
    </a>
</p>
...
自定义spring定时任务starter，sql可执行创建表。有两种使用方式：   
 ...
 - 其他工具类：[Excel工具类(1.3.8.RELEASE版本集成)](https://github.com/chichengyu/task-spring-boot-starter/blob/main/EXCEL.md)
